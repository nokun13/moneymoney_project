...
public class MoneyDesign implements MouseListener {
	...
	public void setMainDesign() {
		...
		mainPage.title.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage.clockLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		...
		// Font ////////////////////
		mainPage.idLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage.loginF.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage.pwLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage.mainTitle.setTitleFont(new Font("JetBrains Mono", Font.PLAIN, 20));
		// mainPage.pwF.setFont(new Font("휴먼둥근헤드라인", 1, 16));
		mainPage.loginB.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage.signUpB.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));

		mainPage.clockLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		// MainPage2 Design
		setMainDesign2();
	...
	public void setMainDesign2() {
		mainPage2 = moneyPage.mainPage2;
		// Design
		mainPage2.amountTotal.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		mainPage2.amountFirst.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		mainPage2.amountSecond.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		mainPage2.amountThird.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		mainPage2.logoutB.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		...
		mainPage2.mainTitleBorder.setTitleFont(new Font("JetBrains Mono", Font.PLAIN, 20));

		mainPage2.amountTotBorder.setBorder(new LineBorder(borderColor, 2));
		mainPage2.amountTotBorder.setTitleFont(new Font("JetBrains Mono", Font.PLAIN, 18));
	...
	public void setAccountMgrDesign() {
		...
		accMgPage.tf.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		accMgPage.bankBox.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		accMgPage.box.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
	...
	public void setInputDesign() {
		...
		// 글씨체,크기 변경
		inputPage.dateLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.dateText.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		inputPage.accountLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.accountCob.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		inputPage.amountLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.amountText.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		inputPage.categoryLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.categoryCob.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		inputPage.contentLabel.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.contentText.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));

		inputPage.inputBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.depositBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
		inputPage.withdrawBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 16));
...
//		recordPage.semiAnnualBtn.setBorderPainted(false);
		...
		recordPage.weekBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordPage.monthBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordPage.semiAnnualBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordPage.tongBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordPage.detailBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));

		recordPage.totalTxt.setFont(new Font("JetBrains Mono", Font.PLAIN, 20));
		recordPage.sumTxt.setFont(new Font("JetBrains Mono", Font.PLAIN, 20));
		recordPage.table.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		header.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
	}
	...
	public void setRecordDetailDesign() {
		...
		// Design
		recordDetail.incomeBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordDetail.expensesBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordDetail.exCate1.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate2.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate3.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate4.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate5.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate6.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate7.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate8.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate9.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate10.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate11.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.exCate12.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));

		recordDetail.inCate1.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.inCate2.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.inCate3.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.inCate4.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.inCate5.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
		recordDetail.inCate6.setFont(new Font("JetBrains Mono", Font.PLAIN, 14));
	...
	public void setRecordChartDesign() {
		...
		recordChart.incomeChtBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
		recordChart.expenseChtBtn.setFont(new Font("JetBrains Mono", Font.PLAIN, 18));
